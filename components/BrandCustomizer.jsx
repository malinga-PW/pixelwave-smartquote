...
export default function BrandCustomizer() {
  ...
  return (
    <div className="space-y-6">
      ...
      {notification && (
        <div className="bg-emerald-950/15 border border-emerald-900/30 p-4 rounded-xl text-[13px] text-emerald-400 font-mono">
          {notification}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 glass-panel rounded-2xl p-6 border border-slate-800/80 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Company / Agency Title</label>
              <input
                type="text"
                value={brandTitle}
            ...
            {/* Subdomain */}
            <div className="space-y-1">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Connected Domain / CNAME</label>
              <input
                type="text"
                value={subdomain}
            ...
            {/* Primary Color */}
            <div className="space-y-1">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Primary Brand Color</label>
              <div className="flex gap-2.5">
                ...
                <input
                  ...
                  value={colorPrimary}
                  onChange={(e) => setColorPrimary(e.target.value)}
                  className="flex-1 bg-slate-950/40 border border-slate-850 rounded-xl px-3 py-1.5 text-[13px] text-slate-100 focus:outline-none focus:border-brand-blue font-mono"
                />
              </div>
            </div>
            ...
            {/* Secondary Color */}
            <div className="space-y-1">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Secondary Brand Color</label>
              <div className="flex gap-2.5">
                <input
                  type="color"
            ...
            <div className="space-y-1 sm:col-span-2">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Default Portal Theme</label>
              <div className="flex bg-slate-950/50 p-1 border border-slate-850 rounded-xl">
                {['light', 'dark', 'system'].map((mode) => (
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-lg text-[13px] font-semibold uppercase transition-all duration-300 ${
                      themeMode === mode
        ...
        <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white text-slate-950 p-6 rounded-2xl border border-slate-150 space-y-4 shadow-lg select-none">
              <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[13px] font-black text-slate-900 mt-0.5">INV-2026-X</p>
                </div>
              </div>

              <div className="flex justify-between items-center pt-2">
                <span className="text-[11px] text-slate-400 font-semibold">Total Settle Sum:</span>
          ...
          <div className="glass-panel rounded-2xl p-5 border border-slate-800/80 text-[13px] text-slate-400 leading-relaxed font-medium space-y-2">
            ...
            <div className="bg-slate-950/40 border border-slate-850 rounded-lg p-2 font-mono text-[10px] text-brand-cyan">
